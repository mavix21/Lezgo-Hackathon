                ...
                <div className="grid grid-cols-4 gap-4 align">
                    ...
                    <div className="col-span-2 grid grid-cols-3 gap-4">
                        <div className="col-span-1">
                            <div className="bg-blue-500 text-white text-center py-2 rounded-t">PREVENTA</div>
                            <div className="bg-gray-200 text-center py-2 rounded-b">Julio 5, 2024 - 20hrs</div>
                            <div className="bg-white text-center py-4 rounded mt-2">S/. 99</div>
                            <div className="bg-gray-300 text-center py-2 rounded mt-2">Cantidad: 200</div>
                            <div className="bg-white text-center py-4 rounded mt-2">S/. 200</div>
                            <div className="bg-gray-300 text-center py-2 rounded mt-2">Cantidad: 50</div>
                            <div className="bg-white text-center py-4 rounded mt-2">S/. 400</div>
                            <div className="bg-gray-300 text-center py-2 rounded mt-2">Cantidad: 50</div>
                        </div>
                        <div className="col-span-1">
                            ...
                            <div className="bg-gray-300 text-center py-2 rounded mt-2">Cantidad: 200</div>
                            <div className="bg-white text-center py-4 rounded mt-2">S/. 250</div>
                            <div className="bg-gray-300 text-center py-2 rounded mt-2">Cantidad: 20</div>
                            <div className="bg-white text-center py-4 rounded mt-2">S/. 500</div>
                            <div className="bg-gray-300 text-center py-2 rounded mt-2">Cantidad: 50</div>
                        </div>
                        <div className="col-span-1">
                            <div className="bg-blue-500 text-white text-center py-2 rounded-t">PRECIO REGULAR</div>
                            <div className="bg-gray-200 text-center py-2 rounded-b">Julio 21, 2024 - 20hrs</div>
                            <div className="bg-white text-center py-4 rounded mt-2">S/. 150</div>
                            <div className="bg-gray-300 text-center py-2 rounded mt-2">Cantidad: 100</div>
                            <div className="bg-white text-center py-4 rounded mt-2">S/. 350</div>
                            <div className="bg-gray-300 text-center py-2 rounded mt-2">Cantidad: 10</div>
                            <div className="bg-white text-center py-4 rounded mt-2">S/. 600</div>
                            <div className="bg-gray-300 text-center py-2 rounded mt-2">Cantidad: 50</div>
                        </div>
                    </div>
                    <div className="col-span-1 space-y-4">
                        ...
                        <div className="pt-6 flex items-center justify-center">
                            <Button className="w-64">Crear</Button>
                        </div>
                    </div>
                </div>
            </main>
